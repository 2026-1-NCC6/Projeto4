                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: localizationService.translate('email').toUpperCase(),
                        ...
                        TextFormField(
                          ...
                          style: TextStyle(color: isDark ? Colors.white : Colors.black),
                          decoration: InputDecoration(
                            labelText: localizationService.translate('password').toUpperCase(),
                        ...
                        Align(
                          ...
                          child: TextButton(
                            ...
                            child: Text(
                              localizationService.translate('forgot_password').toUpperCase(),
                              style: TextStyle(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            child: authViewModel.isLoading
                                ...
                                : Text(localizationService.translate('login').toUpperCase(), style: const TextStyle(fontWeight: FontWeight.w900, letterSpacing: 1.5)),
                          ),
                        ),
                        const SizedBox(height: 24),
                        TextButton(
                          ...
                          child: Text(
                            localizationService.translate('register').toUpperCase(),
                            style: TextStyle(
